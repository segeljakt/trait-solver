...
fn test_lexer_keywords0() {
    let mut lexer = Lexer::new(
        0,
        "def impl struct enum where var type from into select true false",
    );
    ...
    assert_eq!(lexer.next(), Some((Span::new(0, 21, 26), Token::Where)));
    assert_eq!(lexer.next(), Some((Span::new(0, 27, 30), Token::Var)));
    assert_eq!(lexer.next(), Some((Span::new(0, 31, 35), Token::Type)));
    assert_eq!(lexer.next(), Some((Span::new(0, 36, 40), Token::From)));
    assert_eq!(lexer.next(), Some((Span::new(0, 41, 45), Token::Into)));
    assert_eq!(lexer.next(), Some((Span::new(0, 46, 52), Token::Select)));
    assert_eq!(lexer.next(), Some((Span::new(0, 53, 57), Token::True)));
    assert_eq!(lexer.next(), Some((Span::new(0, 58, 63), Token::False)));
    assert_eq!(lexer.next(), Some((Span::new(0, 63, 63), Token::Eof)));
    assert_eq!(lexer.next(), None);
}
...
fn test_lexer_punct0() {
    ...
    assert_eq!(lexer.next(), Some((Span::new(0, 40, 40), Token::Eof)));
    assert_eq!(lexer.next(), None);
}
...
fn test_lexer_err0() {
    ...
    assert_eq!(lexer.next(), Some((Span::new(0, 16, 17), Token::Err)));
    assert_eq!(lexer.next(), Some((Span::new(0, 17, 17), Token::Eof)));
    assert_eq!(lexer.next(), None);
}
...
fn test_lexer_unused0() {
    let mut lexer = Lexer::new(0, ":: => -> <- ..=");
    assert_eq!(lexer.next(), Some((Span::new(0, 0, 1), Token::Colon)));
    assert_eq!(lexer.next(), Some((Span::new(0, 1, 2), Token::Colon)));
    assert_eq!(lexer.next(), Some((Span::new(0, 3, 4), Token::Eq)));
    assert_eq!(lexer.next(), Some((Span::new(0, 4, 5), Token::RAngle)));
    assert_eq!(lexer.next(), Some((Span::new(0, 6, 7), Token::Minus)));
    assert_eq!(lexer.next(), Some((Span::new(0, 7, 8), Token::RAngle)));
    assert_eq!(lexer.next(), Some((Span::new(0, 9, 10), Token::LAngle)));
    assert_eq!(lexer.next(), Some((Span::new(0, 10, 11), Token::Minus)));
    assert_eq!(lexer.next(), Some((Span::new(0, 12, 14), Token::DotDot)));
    assert_eq!(lexer.next(), Some((Span::new(0, 14, 15), Token::Eq)));
